    ...
    <section id="hero" className="pt-20 pb-10 md:pt-32 md:pb-20 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-6 md:gap-12">
        ...
        >
          ...
          >
            Dreamy Doll menghadirkan gantungan kunci boneka rajut (amigurumi) handmade dengan cinta. Sempurna untuk kado, koleksi, atau penghias tas favoritmu.
          </motion.p>
          <motion.div 
            variants={itemVariants}
        ...
        >
          ...
          >
            <img 
              src="https://images.unsplash.com/photo-1590059345025-055c829e2468?auto=format&fit=crop&q=80&w=600" 
              alt="Boneka Amigurumi Cantik"
