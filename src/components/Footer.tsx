      ...
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-4 gap-12 mb-12">
        <div className="space-y-4">
          ...
          <p className="text-slate-500 text-sm leading-relaxed">
            Spesialis gantungan kunci custom dengan desain lucu dan kualitas premium. Wujudkan karakter impianmu bersama kami.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-slate-600">
            <li className="flex items-center gap-2"><MessageCircle size={16} /> 0896-8563-5848</li>
            <li className="flex items-center gap-2">📍 Denpasar, Bali</li>
